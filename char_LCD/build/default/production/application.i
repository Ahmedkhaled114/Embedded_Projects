...
# 41 "./ecu/led/../../mcal/gpio/mcal_gpio.h"
typedef enum {
...
lcd_send_custome_char(&lcd_1 ,1 ,18 ,blt ,1);
    while(1){
        ...
        lcd_send_custome_char(&lcd_1 ,1 ,19 ,character1 ,0); _delay((unsigned long)((250)*(8000000UL/4000.0)));
        lcd_send_custome_char(&lcd_1 ,1 ,19 ,character2 ,0); _delay((unsigned long)((250)*(8000000UL/4000.0)));
        lcd_send_custome_char(&lcd_1 ,1 ,19 ,character3 ,0); _delay((unsigned long)((250)*(8000000UL/4000.0)));
        lcd_send_custome_char(&lcd_1 ,1 ,19 ,character4 ,0); _delay((unsigned long)((250)*(8000000UL/4000.0)));
        lcd_send_custome_char(&lcd_1 ,1 ,19 ,character5 ,0); _delay((unsigned long)((250)*(8000000UL/4000.0)));
        lcd_send_custome_char(&lcd_1 ,1 ,19 ,character6 ,0); _delay((unsigned long)((250)*(8000000UL/4000.0)));
        }
