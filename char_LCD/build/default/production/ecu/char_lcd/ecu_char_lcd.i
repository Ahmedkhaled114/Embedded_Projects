...
# 2 "<built-in>" 2
# 1 "ecu/char_lcd/ecu_char_lcd.c" 2
...
# 8 "ecu/char_lcd/ecu_char_lcd.c" 2


# 1 "ecu/char_lcd/ecu_char_lcd.h" 1
# 12 "ecu/char_lcd/ecu_char_lcd.h"
# 1 "ecu/char_lcd/../../mcal/gpio/mcal_gpio.h" 1
# 13 "ecu/char_lcd/../../mcal/gpio/mcal_gpio.h"
# 1 "ecu/char_lcd/../../mcal/gpio/../../std_types.h" 1
# 11 "ecu/char_lcd/../../mcal/gpio/../../std_types.h"
...
# 11 "ecu/char_lcd/../../mcal/gpio/../../std_types.h" 2
...
# 41 "ecu/char_lcd/../../mcal/gpio/mcal_gpio.h"
typedef enum {
...
# 35 "ecu/char_lcd/ecu_char_lcd.h"
typedef struct{
# 44 "ecu/char_lcd/ecu_char_lcd.h"
...
# 10 "ecu/char_lcd/ecu_char_lcd.c" 2
# 45 "ecu/char_lcd/ecu_char_lcd.c"
static void lcd_4bit_intialize(const char_lcd_t *_lcd){
    ...
    gpio_pin_direction_initialize(_lcd->lcd_data_port, _lcd->lcd_en_pin, DIRECTION_OUTPUT);
    gpio_pin_direction_initialize(_lcd->lcd_data_port, _lcd->lcd_rs_pin, DIRECTION_OUTPUT);
    gpio_pin_write_value(_lcd->lcd_data_port, _lcd->lcd_data_pin4, LOW);
    gpio_pin_write_value(_lcd->lcd_data_port, _lcd->lcd_data_pin5, LOW);
    gpio_pin_write_value(_lcd->lcd_data_port, _lcd->lcd_data_pin6, LOW);
    gpio_pin_write_value(_lcd->lcd_data_port, _lcd->lcd_data_pin7, LOW);
    gpio_pin_write_value(_lcd->lcd_data_port, _lcd->lcd_en_pin, LOW);
    gpio_pin_write_value(_lcd->lcd_data_port, _lcd->lcd_rs_pin, LOW);
...
static void lcd_send_enable(const char_lcd_t *_lcd){
    ...
    gpio_pin_write_value(_lcd->lcd_data_port, _lcd->lcd_en_pin, HIGH);
...
# 106 "ecu/char_lcd/ecu_char_lcd.c"
...
# 129 "ecu/char_lcd/ecu_char_lcd.c"
ret_status lcd_intialize(const char_lcd_t *_lcd){
...
# 145 "ecu/char_lcd/ecu_char_lcd.c"
ret_status lcd_send_command(const char_lcd_t *_lcd, uint8_t command){
...
# 179 "ecu/char_lcd/ecu_char_lcd.c"
ret_status lcd_send_char_data(const char_lcd_t *_lcd, uint8_t _data){
    ret_status ret = R_NOK;
    if(((void*)0) == _lcd){
        return ret;
        ...
        gpio_pin_write_value(_lcd->lcd_data_port, _lcd->lcd_rs_pin, HIGH);
...
# 211 "ecu/char_lcd/ecu_char_lcd.c"
ret_status lcd_send_char_data_pos(const char_lcd_t *_lcd, uint8_t row, uint8_t coulmn, uint8_t _data){
    ret_status ret = R_NOK;
    if(((void*)0) == _lcd){
        return ret;
...
# 233 "ecu/char_lcd/ecu_char_lcd.c"
ret_status lcd_send_string_data_current_pos(const char_lcd_t *_lcd, uint8_t *_data){
    ret_status ret = R_NOK;
    if(((void*)0) == _lcd){
        return ret;
...
# 258 "ecu/char_lcd/ecu_char_lcd.c"
ret_status lcd_send_string_data_pos(const char_lcd_t *_lcd, uint8_t row, uint8_t coulmn, uint8_t *_data){
    ret_status ret = R_NOK;
    if(((void*)0) == _lcd){
        return ret;
...
# 286 "ecu/char_lcd/ecu_char_lcd.c"
ret_status lcd_send_custome_char(const char_lcd_t *_lcd, uint8_t row, uint8_t coulmn, const char arr[], uint8_t _pos){
     ret_status ret = R_NOK;
     uint8_t l_counter = 0;
    if(((void*)0) == _lcd){
        ...
        lcd_send_command(_lcd, 0x40 +(_pos*8));
...
# 311 "ecu/char_lcd/ecu_char_lcd.c"
ret_status lcd_clear_display(const char_lcd_t *_lcd){
    ret_status ret = R_OK;
    if(((void*)0) == _lcd){
        return ret;
...
# 329 "ecu/char_lcd/ecu_char_lcd.c"
void byte_to_string(uint8_t number, uint8_t *_output){
    sprintf(_output, "%i", number);
}
# 340 "ecu/char_lcd/ecu_char_lcd.c"
void short_to_string(uint16_t number, uint8_t *_output){
    sprintf(_output, "%i", number);
}
# 351 "ecu/char_lcd/ecu_char_lcd.c"
void int_to_string(uint32_t number, uint8_t *_output){
    sprintf(_output, "%i", number);
}
