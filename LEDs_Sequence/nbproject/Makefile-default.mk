...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/embeddedApp.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=ecu/button/ecu_button.c ecu/dc_motor/ecu_dc_motor.c ecu/led/ecu_led.c ecu/relay/ecu_relay.c mcal/gpio/mcal_gpio.c application.c device_confg.c ecu/char_lcd/ecu_char_lcd.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/ecu/button/ecu_button.p1 ${OBJECTDIR}/ecu/dc_motor/ecu_dc_motor.p1 ${OBJECTDIR}/ecu/led/ecu_led.p1 ${OBJECTDIR}/ecu/relay/ecu_relay.p1 ${OBJECTDIR}/mcal/gpio/mcal_gpio.p1 ${OBJECTDIR}/application.p1 ${OBJECTDIR}/device_confg.p1 ${OBJECTDIR}/ecu/char_lcd/ecu_char_lcd.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/ecu/button/ecu_button.p1.d ${OBJECTDIR}/ecu/dc_motor/ecu_dc_motor.p1.d ${OBJECTDIR}/ecu/led/ecu_led.p1.d ${OBJECTDIR}/ecu/relay/ecu_relay.p1.d ${OBJECTDIR}/mcal/gpio/mcal_gpio.p1.d ${OBJECTDIR}/application.p1.d ${OBJECTDIR}/device_confg.p1.d ${OBJECTDIR}/ecu/char_lcd/ecu_char_lcd.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/ecu/button/ecu_button.p1 ${OBJECTDIR}/ecu/dc_motor/ecu_dc_motor.p1 ${OBJECTDIR}/ecu/led/ecu_led.p1 ${OBJECTDIR}/ecu/relay/ecu_relay.p1 ${OBJECTDIR}/mcal/gpio/mcal_gpio.p1 ${OBJECTDIR}/application.p1 ${OBJECTDIR}/device_confg.p1 ${OBJECTDIR}/ecu/char_lcd/ecu_char_lcd.p1

# Source Files
SOURCEFILES=ecu/button/ecu_button.c ecu/dc_motor/ecu_dc_motor.c ecu/led/ecu_led.c ecu/relay/ecu_relay.c mcal/gpio/mcal_gpio.c application.c device_confg.c ecu/char_lcd/ecu_char_lcd.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/embeddedApp.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/device_confg.p1: device_confg.c  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/device_confg.p1.d 
	@${RM} ${OBJECTDIR}/device_confg.p1 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits $(COMPARISON_BUILD)  -std=c99 -gcoff -mstack=compiled:auto:auto:auto     -o ${OBJECTDIR}/device_confg.p1 device_confg.c 
	@-${MV} ${OBJECTDIR}/device_confg.d ${OBJECTDIR}/device_confg.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/device_confg.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/embeddedApp.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=dist/${CND_CONF}/${IMAGE_TYPE}/embeddedApp.${IMAGE_TYPE}.map  -D__DEBUG=1  -DXPRJ_default=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits -std=c99 -gcoff -mstack=compiled:auto:auto:auto        $(COMPARISON_BUILD) -Wl,--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -o dist/${CND_CONF}/${IMAGE_TYPE}/embeddedApp.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	@${RM} dist/${CND_CONF}/${IMAGE_TYPE}/embeddedApp.${IMAGE_TYPE}.hex 
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/embeddedApp.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=dist/${CND_CONF}/${IMAGE_TYPE}/embeddedApp.${IMAGE_TYPE}.map  -DXPRJ_default=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits -std=c99 -gcoff -mstack=compiled:auto:auto:auto     $(COMPARISON_BUILD) -Wl,--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -o dist/${CND_CONF}/${IMAGE_TYPE}/embeddedApp.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
