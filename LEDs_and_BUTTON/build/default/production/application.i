...
# 40 "./ecu/led/../../mcal/gpio/mcal_gpio.h"
typedef enum {
...
# 54 "application.c"
    ...
    uint8_t l_inti_counter = 0 ;
    for (l_inti_counter = 0 ; l_inti_counter <3 ; l_inti_counter++){
